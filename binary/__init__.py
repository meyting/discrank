...
df1f = df1[df1.race=="Asian"]
df1m = df1[df1.race=="Hispanic"]
df2f = df2[df2.race=="Asian"]
df2m = df2[df2.race=="Hispanic"]

df1f = df1f[["prolificid", "name", "race", "gender", "matrices"]].sample(n=12, random_state = 1)
df1m = df1m[["prolificid", "name", "race", "gender", "matrices"]].sample(n=12, random_state = 1)
df2f = df2f[["prolificid", "name", "race", "gender", "realeffort"]].sample(n=12, random_state = 1)
df2m = df2m[["prolificid", "name", "race", "gender", "realeffort"]].sample(n=12, random_state = 1)
...
print("111111111XXXXXXXXXXXXXXXXXXXXXXX")
...
print("222222222222XXXXXXXXXXXXXXXXXXXXXXX")
