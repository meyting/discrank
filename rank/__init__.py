...
df1f = df1f[["name", "gender", "matrices", "race"]].sample(n=12, random_state = 1)
df1m = df1m[["name", "gender", "matrices", "race"]].sample(n=12, random_state = 1)
df2f = df2f[["name", "gender", "realeffort", "race"]].sample(n=12, random_state = 1)
df2m = df2m[["name", "gender", "realeffort", "race"]].sample(n=12, random_state = 1)
